...
latex_documents = [
  ('index', 'Snakedeploy.tex', 'Snakedeploy Documentation',
...
man_pages = [
    ('index', 'snakedeploy', 'Snakedeploy Documentation',
     ['Johannes Koester', 'Vanessa Sochat'], 1)
]
...
texinfo_documents = [
  ('index', 'Snakemake', 'Snakedeploy Documentation',
   ['Johannes Koester', 'Vanessa Sochat'], 'Snakedeploy', 'Easily deploy snakemake pipeline templates.',
   'Miscellaneous'),
]
